...
The labels of the events are (decorations of) uncoordinated prefixes
$\apref$: labels are either just uncoordinated prefixes $\apref$
or of the form $\alabel$ with $\apref$ an uncoordinated prefix.
%
