...
$\aloc$, \eMnote{Problema: $\aloc$ vs $\alocvar$}
...
To sum up, we say that a choice as in~\eqref{eq:ch} is
\emph{well-branched}, written
$\wb[{\big\{\bigcup_{i \in I}\apref_i\mkop{.}\aK_i\big\}}]$, when it
is confusion free, there is a unique active role, all other roles are
passive.
