...
There are several major peculiarities w.r.t. to the literature on global types.
...
Global types are equipped with a partial order semantics of events and local types with an ordinary operational semantics. Then, the conditions under which the behaviour of projected local types is faithful to the semantics of global types are spelled out. 
...
Another main innovation of klaimographies is that they allow one to easily
