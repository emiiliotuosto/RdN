...
$\atuple \sust x y$, is defined such that \todo{AC: a substitution can make the tuple non-well-sorted. Is this a problem?}
%
\[
\begin{array}{r@{}l@{\ = \ } ll}
%\asort
...
$\dn{\atuple}\cap\dn{\atuple'} = \emptyset$ \todo{AC:aggiunto $=\emptyset$} \emph{match} by producing a substitution; formally given
