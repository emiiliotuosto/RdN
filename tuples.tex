...
%                      \aloc \bnfmid
                      ...
                      \wildcard
\end{eqnarray*}
\todo{RB: spiegare il tipo $\wildcard$ (any type? unit type?)}
...
\todo{AC+RB: la tupla $x:\asort \cdot x:\asort'$ con $\asort \neq \asort'$ sarebbe well-sorted in accordo alla definizione, ma forse non la vorremmo? (sembra violare la condizione su partial functions)}
...
$\matches : \tupleset \times \tupleset \to \Sigma$  
