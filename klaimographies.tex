...
optionally executed by an implementation of role $\arole$, while
...
\item either $| \selectors \aL| = 1$ or there exists $\amulti
  P\in\multiroles$ s.t. $\selectors \aL \subseteq \{\amulti P,
  \unknownstar, \unknown\}$
\end{itemize}
